  ...
  if args.state.circle_x && ((args.state.tick_count - args.state.enemy_time) / 60 > 3)
    ...
    if args.state.e1_x
      ...
      args.outputs.sprites << [args.state.e1_x, args.state.e1_y, args.state.e1_size, args.state.e1_size,
                               'mygame/sprites/isometric-violet.png ', args.state.e1_direction]
...
def user_interface(args)
  ...
  args.outputs.sprites << [60, 697.5,  10, 10, 'mygame/sprites/circle-black.png', 90] if args.state.lives > 1
  args.outputs.sprites << [75, 697.5,  10, 10, 'mygame/sprites/circle-black.png', 90] if args.state.lives > 2
  args.outputs.sprites << [90, 697.5,  10, 10, 'mygame/sprites/circle-black.png', 90] if args.state.lives > 3
  if ticks % 255 < 127
...
def sprite(args)
  ...
  if args.state.circle_x
    args.outputs.sprites << [args.state.circle_x, args.state.circle_y, sprite_size, sprite_size,
                             'mygame/sprites/shipBlue.png', args.state.circle_direction]
